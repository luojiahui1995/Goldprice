...
C = 10**4
#for C in list_C:
my_ELM = HiddenLayer(x_train,5, C)
...
E1_ELM = HiddenLayer(x_train, 5,C)
...
E2_ELM = HiddenLayer(x_train, 5, C)
...
E3_ELM = HiddenLayer(x_train, 5, C)
...
E4_ELM = HiddenLayer(x_train, 5, C)
